<script lang="ts">
	import { packages, publicProductsStore } from '../../stores/publicProducts';
...
<svelte:head>
	<title>Paquetes | VAQ+</title>
	<meta
		name="description"
		content="Paquetes de vacunación con descuentos. Esquemas completos en VAQ+."
	/>
</svelte:head>
...
<div class="list-page">
	<div class="container">
		<header class="page-header">
			<h1>Paquetes</h1>
			<p class="page-intro">
				Esquemas completos con descuentos especiales. Consulta precios e información de cada
				paquete.
			</p>
		</header>
		...
		{:else}
			<div class="cards-grid">
				{#each list as product (product.id)}
					<a href="/packages/{product.id}" class="product-card">
